...
#if defined(SQM) || defined(MQS)
static FILE *nabout = stdout;
static int get_mytaskid(){
    return 0;
}
#else
...
typedef void (* LS_METHOD_TYPE)
          (int k, int n, double *x_k, double *fx_k, double *g_k,
           double *x_diff, double *g_diff,
           int ls_maxiter, int *ls_tot_iter, double ls_maxatmov,
           double beta_armijo, double c_armijo, double mu_armijo,
           double ftol_wolfe, double gtol_wolfe,
...
static void
line_search(LS_METHOD_TYPE line_search_method, int min_iter, int ndim,
...
typedef void (* HESSVEC_METHOD_TYPE)
               (int *ndim, double *vec_in, double *vec_out, double *xyz,
                double *grad, int *return_flag, int *label);


static void
tncg_minim(int ndim, int maxiter, double grms_tol, int m_lbfgs,
           HESSVEC_METHOD_TYPE hessvec, LS_METHOD_TYPE ls_method,double *xyz, double *enrg,
    ...
    L01:
      ...
      if (get_mytaskid() == 0) {
         if (PRINT_MINIMZ) {
            energy = *enrg;
            fprintf( nabout,
                " MIN:          It= %4d  nfunc= %5d  E= %15.5f (%9.2e)\n",
...
prcg_minim(int ndim, int maxiter, double grms_tol, int m_lbfgs,
           HESSVEC_METHOD_TYPE hessvec, LS_METHOD_TYPE ls_method, double *xyz,
...
typedef void (* MINIM_METHOD_TYPE)
          (int ndim, int maxiter, double grms_tol, int m_lbfgs,
           HESSVEC_METHOD_TYPE hessvec, LS_METHOD_TYPE ls_method, double *xyz,
           double *enrg, double *grad, double *grms_out, int *iter_out,
           double *total_time, int ls_maxiter, int *ls_iter_out,
           double ls_maxatmov, double beta_armijo, double c_armijo, 
...
static void
minim(MINIM_METHOD_TYPE minim_method, HESSVEC_METHOD_TYPE numdiff_method,
      LS_METHOD_TYPE lsearch_method, int ndim, int maxiter, double grms_tol,
